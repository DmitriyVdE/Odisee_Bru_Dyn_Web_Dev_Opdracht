(function () {
  ...
  window.addEventListener("load", function () {
    ...
    devElements.devWelcome.addEventListener("click", function () {
      setActiveWindow("welcomeWindow");
    });
    devElements.devMenu.addEventListener("click", function () {
      setActiveWindow("menuWindow");
    });
    devElements.devGame.addEventListener("click", function () {
    ...
    function startCountdown() {
      ...
      state.animationFrameIds.countdown = requestAnimationFrame(
        updateCountdown
      );
    }
    ...
    function updateCountdown() {
      if (quiz.timer.timeLeft > 0) {
        ...
        let timeLeftPercentage =
          100 -
          ((timestamp - quiz.timer.startTime) /
            (quiz.timer.initialTime * 1000)) *
            100;
    ...
    function displayAdditionQuestion() {
      ...
      allElements.game.questionTitle.innerHTML =
        quiz.questions["addition"].questionText;
    ...
    function displayColorQuestion() {
      ...
      allElements.game.questionTitle.innerHTML =
        quiz.questions["colors"].questionText;

      allElements.game.questionImage.style.display = "none";
      allElements.game.questionText.style.display = "block";
      allElements.game.questionText.innerHTML = "";
      allElements.game.questionText.style.backgroundColor =
        quiz.current.question.hexValue;
    }
    ...
    function displayAnimalQuestion() {
      ...
      allElements.game.questionTitle.innerHTML =
        quiz.questions["animals"].questionText;
